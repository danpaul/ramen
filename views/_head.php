...
<?php //echo $this->get_menu_data(); die(); ?>
<head>

  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title><?php echo $GLOBALS['config']['settings']['site_name']; ?></title>
 ...
 <link href="<?php echo($GLOBALS['config']['assets_root_url']. '/css/style.css'); ?>" rel="stylesheet" type="text/css">